...
public:
	...
	void				SetRenderState(RENDER_STATE renState, DWORD nValue);
	...
	static void				SetCurFrameTick(DWORD dwTick);
...
inline void MPRender::SetRenderState(RENDER_STATE renState, DWORD nValue)
{
#if(defined USE_MANAGED_RES)
