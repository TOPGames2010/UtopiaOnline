...
public:
	bool Connect(const char *hostname,unsigned short port,unsigned long timeout) const;
	void Disconnect(int reason) const;
	...
	void OpenTeleportNPC() const;               //mothannakh new teleport npc button 
